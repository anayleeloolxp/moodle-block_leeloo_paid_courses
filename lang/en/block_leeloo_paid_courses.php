...
/**
 * Lang strings for leeloo_paid_courses block
 *
...
$string['leeloo_paid_courses:addinstance'] = 'Add a new Leeloo LXP Paid Courses block';
$string['leeloo_paid_courses:myaddinstance'] = 'Add a new Leeloo LXP Paid Courses block to Dashboard';
$string['defaultmaxcourses'] = 'Default maximum courses';
$string['defaultmaxcoursesdesc'] = 'Maximum courses which should be displayed on Leeloo LXP Paid Courses block, 0 will show all courses';
...
$string['pluginname'] = 'Leeloo LXP Paid Courses';
$string['displayname'] = 'Leeloo LXP Paid Courses';
...
$string['leeloo_paid_courses_bgimage'] = "Embed images into background";
$string['leeloo_paid_courses_bgimage_desc'] = "This will embed images into background as a CSS property";
...
$string['privacy:metadata'] = 'The Leeloo LXP Paid Courses (leeloo_paid_courses) block only shows information about courses and does not store data itself.';
